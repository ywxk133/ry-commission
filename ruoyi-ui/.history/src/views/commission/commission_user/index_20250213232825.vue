...
<el-dialog title="账户管理" :visible.sync="accountDialogVisible" width="500px">
  <el-form :model="accountInfo" label-width="100px">
    <el-form-item label="当前余额">
      <el-input v-model="accountInfo.balance" :min="0“ readonly></el-input>
    </el-form-item>
    <el-form-item label="调整余额">
      <el-input-number v-model="balanceAdjustment" :min="0" label="调整金额"></el-input-number>
    </el-form-item>
    <el-button @click="confirmBalanceAdjustment(1,userId)">增加</el-button>
    <el-button @click="confirmBalanceAdjustment(2,userId)">减少</el-button>
