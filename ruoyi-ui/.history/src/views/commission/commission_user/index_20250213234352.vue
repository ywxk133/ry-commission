    ...
    <el-row :gutter="10">
      ...
      <el-col :span="12">
        <el-form-item label="操作">
          <el-button @click="confirmBalanceAdjustment(1)" type="primary" style="width: 50%;">增加</el-button>
          <el-button @click="confirmBalanceAdjustment(2)" type="danger" style="width: 150%;">减少</el-button>
        </el-form-item>
      </el-col>
    </el-row>
